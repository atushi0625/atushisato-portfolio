...
<body <?php body_class(); ?>>
  ...
  <div class="wrapper">
    <!-- header -->
    <?php get_template_part('/dist/assets/includes/header'); ?>
    <!-- /header -->
    ...
    <div class="main-visual">
      <div class="main-visual-inner">
        <img class="main-name-img" src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/pages/top/main-name.jpg" alt="ATUSHI SATO PORTFOLIO" />
        <div class="swiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <picture>
                <source srcset="<?php echo get_template_directory_uri(); ?>/dist/assets/images/pages/top/main-bg-img.jpg" media="(max-width: 768px)" />
                <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/pages/top/main-bg-img.jpg" alt="" />
              </picture>
            </div>
            <div class="swiper-slide">
              <picture>
                <source srcset="<?php echo get_template_directory_uri(); ?>/dist/assets/images/pages/top/main-bg-img2.jpg" media="(max-width: 768px)" />
                <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/pages/top/main-bg-img2.jpg" alt="" />
              </picture>
            </div>
            <div class="swiper-slide">
              <picture>
                <source srcset="<?php echo get_template_directory_uri(); ?>/dist/assets/images/pages/top/main-bg-img3.jpg" media="(max-width: 768px)" />
                <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/pages/top/main-bg-img3.jpg" alt="" />
              </picture>
            </div>
          </div>
        </div>
      ...
      <div class="inner">
        ...
        <div class="profile">
          <div class="profile-img">
            <img data-aos="zoom-in-right" src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/pages/top/profile.jpeg" alt="プロフィール写真" />
          </div>
        ...
        <div class="contact-wrapper" data-aos="fade-up">
          ...
          <div class="contact-list">
            <a class="sns-link" href="https://www.twitter.com/atushisato0625" target="_blank" rel="noopener">
              <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/Twitter-icon.png" alt="twitter公式アイコン" />
            </a>
            <a class="sns-link" href="https://www.instagram.com/atushi213/" target="_blank" rel="noopener">
              <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/Instagram-icon.png" alt="instagram公式アイコン" />
            </a>
            <a class="sns-link" href="https://www.facebook.com/atushi0213" target="_blank" rel="noopener">
              <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/facebook-icon.png" alt="facebook公式アイコン" />
            </a>
          </div>
    ...
    <!-- footer -->
    <?php get_template_part('/dist/assets/includes/footer'); ?>
    <?php get_footer(); ?>
    <!-- /footer -->
  </div>
